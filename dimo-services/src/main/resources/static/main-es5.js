...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    "./src/app/services/ProfileService.ts"); // import { Mat } from '@angular/material/progress-spinner';
  ...
  function srcAppContainersComponentsMoviedetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(MovieDetailsComponent, [{
        key: "viewDetails",
        value: function viewDetails(movie) {
          var id = movie.id;
          this.doSearch(id);
        }
      }, {
